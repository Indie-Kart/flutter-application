...
class ShoeScreen extends StatelessWidget {
  ShoeScreen({Key? key}) : super(key: key);

  GlobalKey<NavigatorState> navigatorKey = GlobalKey();

  static Widget builder(BuildContext context) {
    return BlocProvider<ShoeBloc>(
        create: (context) => ShoeBloc(ShoeState(shoeModelObj: ShoeModel()))
          ..add(ShoeInitialEvent()),
        child: ShoeScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<ShoeBloc, ShoeState>(builder: (context, state) {
      return SafeArea(
          child: Scaffold(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                            ...
                            child: Text("msg_adidas_running_shoe2".tr,
    ...
    return CustomAppBar(
        ...
        title: Container(
            ...
            child: Stack(alignment: Alignment.centerLeft, children: [
              ...
              AppbarSubtitleOne(
                  text: "lbl_shoes".tr,
                  margin: EdgeInsets.fromLTRB(33.h, 4.v, 167.h, 5.v))
            ])));
  }
  ...
  Widget _buildHeartOutlineStack(BuildContext context) {
    return SizedBox(
        ...
        child: Stack(alignment: Alignment.center, children: [
          ...
          CustomImageView(
              imagePath: ImageConstant.imgScreenshot2023292x364,
              height: 292.v,
              width: 364.h,
              alignment: Alignment.center)
        ]));
  ...
  /// Navigates to the cattwoScreen when the action is triggered.
  onTapIconButton(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.cattwoScreen,
    );
  }
